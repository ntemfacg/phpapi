...
if (isset($_POST['signup'])) {
    ...
    $first_name = mysqli_real_escape_string(strip_tags(trim($_POST['first_name']))); // get posted data and remove whitespace
        ...
        <form method="post" autocomplete="off">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <h2 class="">Register for NaturalHR</h2>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="date" name="date_of_birth" class="form-control" placeholder="Enter Date Of Birth" required/>
                    </div>
                </div>
